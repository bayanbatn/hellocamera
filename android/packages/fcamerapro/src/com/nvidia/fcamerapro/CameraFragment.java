 ...
 */
public final class CameraFragment extends Fragment implements OnClickListener, OnSeekBarChangeListener, HistogramDataProvider, OnTouchListener {
	...
	public boolean onTouch(View v, MotionEvent event) {
		if (v == mCameraView && event.getActionMasked() == MotionEvent.ACTION_DOWN
			...
			case 0: 
				...
				break;
			case 1:
				float y = event.getY() / mCameraView.getHeight();
				float x = event.getX() / mCameraView.getWidth();
				iface.enqueueMessageForAutofocusSpot(x, y);//TODO
				break;
			}
			// TODO TODO TODO
			// TODO TODO TODO
